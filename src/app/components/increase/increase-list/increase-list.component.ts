...
@Component({
  ...
  styleUrls: ['./increase-list.component.css']
})
export class IncreaseListComponent implements OnInit {
  ...
  isVisible= false;
  constructor(private userService:IncreaseService,
    ...
    onCreate(){
      ...
      this.dialog.open(IncreaseRegisterComponent,dialogConfig);
